...
type CustomKdu = ComponentPublicInstance & Record<string, any>;
...
interface MapperForState {
  <S, Map extends Record<string, (this: CustomKdu, state: S, getters: any) => any> = {}>(
    map: Map
...
interface MapperForAction {
  <Map extends Record<string, (this: CustomKdu, dispatch: Dispatch, ...args: any[]) => any>>(
    map: Map
...
interface MapperForMutation {
  <Map extends Record<string, (this: CustomKdu, commit: Commit, ...args: any[]) => any>>(
    map: Map
  ): { [K in keyof Map]: InlineMethod<Map[K]> };
}
