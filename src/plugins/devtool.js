import { setupDevtoolsPlugin } from '@nkduy/devtools-api'
import { makeLocalGetters } from '../store-util'

const LABEL_KDUX_BINDINGS = 'kduxs bindings'
const MUTATIONS_LAYER_ID = 'kduxs:mutations'
const ACTIONS_LAYER_ID = 'kduxs:actions'
const INSPECTOR_ID = 'kduxs'
  ...
  setupDevtoolsPlugin(
    {
      ...
      logo: '#',
      packageName: 'kduxs',
      componentStateTypes: [LABEL_KDUX_BINDINGS]
    },
    (api) => {
      api.addTimelineLayer({
        id: MUTATIONS_LAYER_ID,
        label: 'Kduxs Mutations',
...
/**
 * @param {*} module
 * @return {import('@nkduy/devtools-api').CustomInspectorNode}
 */
...
/**
 * @param {import('@nkduy/devtools-api').CustomInspectorNode[]} result
 * @param {*} module
 * @param {string} filter
 * @param {string} path
 */
...
/**
 * @param {*} module
 * @return {import('@nkduy/devtools-api').CustomInspectorState}
 */
